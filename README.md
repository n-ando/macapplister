...
|  -d |  --detail  | Applicationフォルダ内の複数アプリを展開する。<br/>デフォルトでは、/Application/<name>, /Library/<name> の <name> とアプリケーション名が一致する場合には、/App or Lib/<name>/以下に複数のアプリケーションがあっても<name>のみリスト化される。 |
